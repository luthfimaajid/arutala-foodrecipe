...
import arutala.backend.bookrecipe.dto.request.AddBookRecipeRequest;
...
public class RecipeController {
    ...
    public ResponseEntity<Object> addBookRecipe(@RequestBody AddBookRecipeRequest request) {
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Object> addRecipeToFavorites(@PathVariable("recipe_id") Integer recipeId, @RequestBody Map<String, Integer> request) {
